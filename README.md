...
* 启动脚本  
  `wget --no-check-certificate -O gost.sh https://github.moeyy.xyz/https://raw.githubusercontent.com/PainterXIII/YouRanGost/master/gost.sh && chmod +x gost.sh && ./gost.sh`
